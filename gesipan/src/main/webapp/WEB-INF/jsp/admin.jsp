...
<section class="wrapper style1 align-center">
    <div class="inner medium">
        <h2>관리자 페이지</h2>
        <form method="post" action="/board/adminOk">
            <div class="fields">
                ...
                <div class="field half">
                    <label for="email">내용2</label>
                    <input type="text" name="subContent" id="email" value="" />
                </div>
                <div class="field">
        ...
        <div class="table-wrapper">
            <table>
                ...
                <tr>
                    ...
                    <td><c:out value="${board.subContent}"></c:out></td>
                    <td><c:out value="${board.content}"></c:out></td>
                    <td><a href="/board/delete/${board.id}">X</a></td>
                </tr>
                </c:forEach>
                </tbody>
            </table>
